...
import (
	...
	utl "github.com/rafael180496/pocolab-utils/utils"
)
...
func ToFloat64(i interface{}) float64 {
	...
	case string:
		...
		return utl.ReturnIf(err == nil, v, 0).(float64)
	case bool:
		return utl.ReturnIf(s, 1, 0).(float64)
	default:
		return 0
	}
}
...
func ToFloat(i interface{}) float32 {
	...
	case string:
		v, err := strconv.ParseFloat(s, 64)
		return utl.ReturnIf(err == nil, v, 0).(float32)
	case bool:
		return utl.ReturnIf(s, 1, 0).(float32)
	default:
		return 0
	}
}
...
func ToInt64(i interface{}) int64 {
	...
	case string:
		v, err := strconv.ParseFloat(s, 64)
		return utl.ReturnIf(err == nil, v, 0).(int64)
	case bool:
		return utl.ReturnIf(s, 1, 0).(int64)
	case nil:
		return 0
	default:
		return 0
...
func ToInt32(i interface{}) int32 {
	...
	case string:
		v, err := strconv.ParseFloat(s, 64)
		return utl.ReturnIf(err == nil, v, 0).(int32)
	case bool:
		return utl.ReturnIf(s, 1, 0).(int32)
	case nil:
		return 0
	default:
		return 0
...
func ToInt16(i interface{}) int16 {
	...
	case string:
		v, err := strconv.ParseFloat(s, 64)
		return utl.ReturnIf(err == nil, v, 0).(int16)
	case bool:
		return utl.ReturnIf(s, 1, 0).(int16)
	case nil:
		return 0
	default:
		return 0
...
func ToInt8(i interface{}) int8 {
	...
	case string:
		v, err := strconv.ParseFloat(s, 64)
		return utl.ReturnIf(err == nil, v, 0).(int8)
	case bool:
		return utl.ReturnIf(s, 1, 0).(int8)
	case nil:
		return 0
	default:
		return 0
